...
const form = useForm({
    ...
    calories_per_serving: props.recipe.calories_per_serving || 0,
    is_private: props.recipe.is_private || false,
    is_vegan: props.recipe.is_vegan || false,
...
const handleSaveChanges = () => {
    if(!form.isDirty){
        Swal.fire({
            ...
            text: 'You have not made any changes to the recipe.',
            timer: 3000,
    ...
    form.post(`/recipes/${props.recipe.id}/edit`, {
        forceFormData: true,
        preserveScroll: true,
        onSuccess: () => {
            Swal.fire({
                ...
                <div class="recipe-container">
                    <div class="left-section">
                        <label class="image-upload">
                            ...
                            <div class="image-placeholder" v-if="!imagePreview && !form.image_path">
                              ...
                              <div class="image-preview" v-else>
                                <img :src="imagePreview ? imagePreview: `/storage/${form.image_path}`" alt="Recipe preview" />
                                <button type="button" class="remove-image-btn" @click.prevent="removeImage">
                                    <img :src="trashIcon" @click="removeImage" alt="Remove" class="trash-icon" />
                                </button>
                            </div>
                        ...
                        <div class="recipe-stats">
                            <div class="stat-item">
                                <span class="stat-value">{{form.minutes_to_make}}</span>
                        ...
                        <div class="additional-info">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-input" v-model="form.minutes_to_make" placeholder="35" />
                            </div>

                            <div class="form-group">
                                <label class="form-label">Servings</label>
                                <input type="number" class="form-input" v-model="form.servings" placeholder="4" />
                            </div>

                            <div class="form-group">
                                <label class="form-label">Calories per Serving</label>
                                <input type="number" class="form-input" v-model="form.calories_per_serving" placeholder="350" />
                            </div>
